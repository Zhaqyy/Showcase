...
const showcaseData = [
    ...
    },
    {
      ...
      date: "2024-12-19",
      mood: "🌀 Digital Nervous Breakdown",
      difficulty: "Medium (Shaders are like writing poetry in math)",
      personalRating: 4.1,
      likes: 0,
      interactionType: "Mouse Movement",
      soundtrack: "Synthwave Anxiety",
      bestViewedWith: "Slightly caffeinated state",
      secretInteraction: "Move mouse in circles to create vortex",
      timeToBuild: "1 day",
      inspiration: "That time I stared at oscilloscope patterns for too long",
      warning: "May cause line-related paranoia"
    },
    {
      id: 15,
      title: "Sundial",
      category: "WebGL",
      description: "A 3D sundial with festival dates arranged in a circular pattern around a central figure.",
      tags: ["3D", "Interactive", "Calendar"],
      thumbnail: "/Thumbnail/sundial.webp",
      commentary: "Time is a flat circle, but festivals are arranged in a 3D sundial. This piece visualizes a summer of music festivals as a temporal compass, with each date radiating from the center like rays of sunlight. The shadow moves to show the passage of time.",
      component: () => import("../Showcase/Sundial"),
      tech: ["Three.js", "React Three Fiber", "GSAP"],
      date: "2024-12-20",
      mood: "🌞 Festival Time Machine",
      difficulty: "Medium (Circular math + 3D positioning)",
      personalRating: 4.3,
      likes: 0,
      interactionType: "Orbit Controls + Auto Animation",
      soundtrack: "Summer Festival Vibes",
      bestViewedWith: "Fullscreen + festival nostalgia",
      secretInteraction: "Click and drag to rotate the sundial",
      timeToBuild: "1 day",
      inspiration: "That festival calendar that looked like a sundial",
      warning: "May cause intense festival FOMO"
    },
